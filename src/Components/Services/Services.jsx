  ...
  return (
    <section className='container py-5 '>
        ...
        <container className='d-flex align-items-center gap-5'>
            <h1 className='flex1 my-1'>WE Offer our best services</h1>
            <div className='d-flex align-items-center gap-3 flex2 flex-wrap'>
            {services.map((value,index)=>(
                <div key={index} className='flex2 w-100 cardbox'>
